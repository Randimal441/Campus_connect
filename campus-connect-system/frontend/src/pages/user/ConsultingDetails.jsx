              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-4 w-full space-y-2 border-t border-gray-100 pt-3">
                  <div className="flex items-center justify-center text-gray-700">
                    ...
                    <a href="tel:+15552345678" className="text-sm hover:text-teal-600">(+94) 765578439</a>
                  </div>
                  <div className="flex items-center justify-center text-gray-700">
                    <svg className="w-5 h-5 text-teal-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href={`mailto:${consultant.email || 'dr.mitchell@therapy.com'}`} className="text-sm hover:text-teal-600">{consultant.email || 'dr.mitchell@therapy.com'}</a>
                  </div>
                </div>
